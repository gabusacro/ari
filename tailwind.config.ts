  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        card: "0 2px 8px 0 rgb(15 28 46 / 0.06), 0 8px 24px -4px rgb(15 28 46 / 0.1), 0 16px 48px -8px rgb(15 28 46 / 0.12)",
        "card-hover": "0 4px 12px 0 rgb(15 28 46 / 0.1), 0 12px 32px -4px rgb(15 28 46 / 0.14), 0 24px 56px -8px rgb(15 28 46 / 0.16)",
